...
위의 그림에서 프로세스는 시스템 콜을 통해 커널에 I/O 작업을 요청하고, **I/O 장치에서 해당 작업을 완료하여 결과를 반환할 때까지 해당 프로세스는 블로킹** 된다. 
...
위의 그림에서 프로세스는 시스템 콜을 통해 커널에 I/O 작업을 요청하고, **곧바로 제어권을 돌려 받아서 I/O 작업 완료 여부와 상관없이 다른 작업을 수행**할 수 있다.
